...
and the SAME event bus (pointed at one shared database). That is what lets any
...
def build_cluster_backends(
    dsn: str,
) -> tuple[VersionedDatabaseTaskStore, DatabaseTaskEventBus]:
    """Builds a versioned store + event bus over the shared database.
